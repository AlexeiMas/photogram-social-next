...
const Header = () => {
  return (
    <header className='fixed md:hidden bg-white top-0 flex items-center justify-between dark:bg-neutral-950 w-full z-50 border-b border-zinc-300 dark:border-neutral-700 px-3 py-2 sm:-ml-6 space-x-2'>
      <Link href={'/dashboard'}>
        <p className={`${moonDance.className} font-semibold text-xl`}>Instagram</p>
      </Link>
