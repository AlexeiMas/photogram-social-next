...
import { Bookmark, Clapperboard, Contact, Grid3X3, LucideProps } from 'lucide-react';
...
const profileTabs: (Record<'title' | 'href', string> & {
...
const ProfileTabs = ({ profile, isCurrentUser }: IProfileTabsProps) => {
